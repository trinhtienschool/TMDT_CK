					...
					<div class="col-md-8">
						...
						<div class="card card-table flex-fill">
							...
							<div class="card-body">
								...
								%>
								<canvas  data-revenue="${pageContext.getAttribute("total_price")}" data-labels="['Thu 2','Thu 3','Thu 4','Thu 5', 'Thu 6','Thu 7','Chu nhat']" id="revenue" ></canvas>
							</div>
						</div>
						<!-- /Recent Bookings -->
					</div>
									...
									<table class="table table-center">
										...
										<c:forEach items="${top3bestsup}" var="sup">
											...
											<tr>
												...
												<td>
													<div class="font-weight-600"><%= Util.formatCurrency((double)pageContext.getAttribute("total")) %></div>
												</td>
												<td>
													<a href="../supplier?vendor=${sup.slug}" class="btn btn-sm bg-info-light">

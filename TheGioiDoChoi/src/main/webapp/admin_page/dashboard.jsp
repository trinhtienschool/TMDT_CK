                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-widget-info">
                                    <h3>${c_user_month}</h3>
                                    <h6 class="text-muted">Người dùng mới tháng này</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-widget-info">
                                    ...
                                    <h6 class="text-muted">Tổng doanh thu các cửa hàng tháng này</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-widget-info">
                                    <h3>${Util.formatCurrency(commissionRevenue)}</h3>
                                    <h6 class="text-muted">Tổng hoa hông tháng này</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin: 0 !important;">
                        ...
                        <div class="card card-table flex-fill">
                            ...
                            <div class="m-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <select onchange="this.form.submit()" name="type-revenue"
                                                class="form-control select">
                                            <option value="week"
                                                    <c:if test="${type_revenue.equals('week')}">selected</c:if>>Tuần
                                                này
                                            </option>
                                            <option value="month"
                                                    <c:if test="${type_revenue.equals('month')}">selected</c:if>>
                                                Tháng này
                                            </option>
                                            <option value="quarter"
                                                    <c:if test="${type_revenue.equals('quarter')}">selected</c:if>>
                                                Quý này
                                            </option>
                                            <option value="year-quarter"
                                                    <c:if test="${type_revenue.equals('year-quarter')}">selected</c:if>>
                                                Năm
                                                này (xem theo quý)
                                            </option>
                                            <option value="year-month"
                                                    <c:if test="${type_revenue.equals('year-month')}">selected</c:if>>
                                                Năm
                                                này (xem theo tháng)
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="cal-icon">
                                            <input style="display: none" name="type-range" type="checkbox"
                                                   id="chart-form-checkbox">
                                            <input
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${data_commission!=null}">
                                    <canvas data-revenue_commission='${data_commission}'
                                            data-revenue_vendor='${data_vendor}' data-labels="${labels_revenue}"
                                            id="revenue-stack-chart"></canvas>
                                </c:if>
                            </div>
                        </div>
                        <!-- /Recent Bookings -->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-table flex-fill">
                            ...
                            <div class="m-2">
                                <select onchange="this.form.submit()" name="type-revenue-circle"
                                        class="form-control select">
                                    <c:out value="${type_revenue_circle}"/>
                                    <c:forEach items="${date_range}" var="date">
                                        <c:out value="${date}"/>
                                        <option value="${date}"
                                                <c:if test="${type_revenue_circle==date}">selected</c:if>>
                                            Tháng ${date}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="card-body">
                                <c:if test="${data_circle !=null}">
                                    <canvas data-revenue='${data_circle}' data-labels="${labels_circle}"
                                            id="order-status"></canvas>
                                </c:if>
                            </div>
                        </div>
                        <!-- /Recent Bookings -->
                                ...
                                <table class="table table-center">
                                    ...
                                    <c:forEach items="${top3bestsup}" var="sup">
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${fn:startsWith(sup.logo, 'imgs')}">
                                                     src="../${sup.logo}"</c:if>

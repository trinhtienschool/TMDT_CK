...
<head>
    ...
    <link href="../imgs/header/shortcut.png" rel="shortcut icon">

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.png">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="admin_page/assets/css/bootstrap.min.css">
    ...
    <!-- Feathericon CSS -->
    <link rel="stylesheet" href="admin_page/assets/css/feathericon.min.css">
...
<div class="main-wrapper">
    ...
    <div class="error-box">
        ...
        <p class="h4 font-weight-normal">Trang web bạn đang yêu cầu hiện không tồn tại</p>
        <a href="../home" class="btn btn-primary">Trở lại trang chủ</a>
    </div>

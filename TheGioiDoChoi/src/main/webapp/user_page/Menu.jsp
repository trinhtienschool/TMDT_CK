    ...
    <div class="header__top">
        <div class="container">
            ...
            <div class="header__right">
                ...
                <a class="header__extra" href="user"><i class="icon-heart"></i><span><i>${sessionScope.favourist.size}</i></span></a>
                    </c:if>
                    <c:if test="${sessionScope.user_id==null}">
                    <a class="header__extra" style="visibility: hidden" href="user"><i class="icon-heart"></i><span><i>0</i></span></a>
                        </c:if>
    ...
    <div class="ps-panel__content">
        <ul class="menu--mobile">
            <li class="menu-item-has-children">
                ...
                <a href="shopping">Siêu sale</a>
                <a href="shopping">Sản phẩm</a>
                <a href="#">Blog</a>
